...
public class temporarily {
	...
	public static void valCheck(int pTagNum, int btnNum, String val) {
		...
		switch(val){
			case "scriptList_email_null": checkMsg = "수신 이메일을 입력해 주세요.";
			break;
			case "scriptList_email_validation": checkMsg = "이메일 주소가 올바르지 않습니다.";
			break;
			case "scriptList_email_send": checkMsg = "설치안내 메일이 발송되었습니다.";
			break;
			case "installApply_null": checkMsg = "신청할 서비스를 선택해 주세요.";
			break;
			case "installApply_name_null": checkMsg = "이름을 입력해 주세요.";
			break;
			case "installApply_email_null": checkMsg = "이메일을 입력해 주세요.";
			break;
			case "installApply_email_validation": checkMsg = "이메일 형식이 올바르지 않습니다.";
			break;
			case "installApply_FTP_null": checkMsg = "FTP정보를 입력해 주세요.";
			break;
			case "installApply_port_null": checkMsg = "포트번호를 입력해 주세요.";
			break;
			case "installApply_id_null": checkMsg = "아이디를 입력해 주세요.";
			break;
			case "installApply_pw_null": checkMsg = "비밀번호를 입력해 주세요.";
			break;
			case "installApply_agree_null": checkMsg = "개인정보 수집 및 이용에 대한 안내를 동의해 주세요.";
			break;
			case "memberInfo_checkpage_pw_null": checkMsg = "비밀번호를 입력하세요.";
			break;
			case "memberInfo_oldPw_null": checkMsg = "현재 비밀번호를 입력하세요.";
			break;
			case "memberInfo_newPw_null": checkMsg = "새 비밀번호를 입력하세요.";
			break;
			case "memberInfo_newPwCk_null": checkMsg = "새 비밀번호 확인이 필요합니다.";
			break;
			case "memberInfo_newPw_validation": checkMsg = "새 비밀번호가 일치하지 않습니다.";
			break;
			case "memberInfo_pw_confirm": checkMsg = "비밀번호를 변경 하시겠습니까?";
			break;
			case "memberInfo_pw_alert": checkMsg = "비밀번호 변경이 완료되었습니다.";
			break;
			case "memberInfo_pw1_confirm": checkMsg = "비밀번호를 변경 하시겠습니까?";
			break;
			case "memberInfo_pw1_alert": checkMsg = "비밀번호 변경이 완료되었습니다.";
			break;
			case "memberInfo_name_null": checkMsg = "담당자 이름을 입력하세요.";
			break;
			case "memberInfo_email_null": checkMsg = "이메일 주소를 입력하여 주세요.";
			break;
			case "memberInfo_email_validation": checkMsg = "이메일 주소가 올바르지 않습니다.";
			break;
			case "memberInfo_change_ok": checkMsg = "회원정보가 수정되었습니다.";
			break;
			case "memberInfo_change1_ok": checkMsg = "회원정보가 수정되었습니다.";
			break;            
			case "myCoupon_1_null": checkMsg = "쿠폰번호가 맞지 않습니다.\n" + "다시 확인해 주세요";
			break;
			case "myCoupon_2_null": checkMsg = "쿠폰번호가 맞지 않습니다.\n" + "다시 확인해 주세요";
			break;
			case "myCoupon_3_null": checkMsg = "쿠폰번호가 맞지 않습니다.\n" + "다시 확인해 주세요";
			break;
			case "myCoupon_4_null": checkMsg = "쿠폰번호가 맞지 않습니다.\n" + "다시 확인해 주세요";
			break;
			case "myCoupon_5_null": checkMsg = "존재하지 않는 쿠폰입니다.\n" + "다시 확인해 주세요.";
			break;
			case "editService_modify_check": checkMsg = "변경된 정보가 없습니다.";
			break;
			case "addService_siteName_null": checkMsg = "웹사이트 이름을 입력해주세요.";
			break;
			case "addService_domain_null": checkMsg = "등록된 도메인이 없습니다.";
			break;
			case "addService_domain_validation": checkMsg = "도메인 형식이 올바르지 않습니다.";
			break;
			case "addService_domain_duplication": checkMsg = "이미 추가된 도메인입니다.";
			break;
			case "addService_siteGroup1_null": checkMsg = "웹사이트 분류를 선택해주세요.";
			break;
			case "addService_siteGroup2_null": checkMsg = "웹사이트 분류를 선택해주세요.";
			break;
			case "addService_coupon_null": checkMsg = "쿠폰번호가 맞지 않습니다.\n" + "다시 확인해 주세요.";
			break;
			case "addIntegralReport_name_null": checkMsg = "통합리포트 이름을 입력해 주세요.";
			break;
			case "addIntegralReport_service_null": checkMsg = "2개 이상의 서비스를 선택해 주세요.";
			break;
			case "editService_siteName_null": checkMsg = "웹사이트 이름을 입력해주세요.";
			break;
			case "editService_domain_null": checkMsg = "등록된 도메인이 없습니다.";
			break;
			case "editService_domain_validation": checkMsg = "도메인 형식이 올바르지 않습니다.";
			break;
			case "editService_edit_alert": checkMsg = "수정이 완료되었습니다.";
			break;
